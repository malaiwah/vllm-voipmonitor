    ...
    def _forward_core(
        ...
        if spec_sequence_masks is not None:
            if attn_metadata.num_prefills == 0 and attn_metadata.num_decodes == 0:
                ...
                # upstream #51812 (ported 2026-08-19): gates must follow the
                # same spec/non-spec row split as qkv, or spec tokens run the
                # GDN update with wrong-row gates in mixed batches.
                a_spec = a
                b_spec = b
